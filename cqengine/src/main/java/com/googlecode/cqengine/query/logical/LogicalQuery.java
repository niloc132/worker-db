...
public abstract class LogicalQuery<O> implements Query<O> {
    ...
    Collection<Query<O>> childQueries;
    List<LogicalQuery<O>> logicalQueries = new ArrayList<LogicalQuery<O>>();
    List<SimpleQuery<O, ?>> simpleQueries = new ArrayList<SimpleQuery<O, ?>>();
    boolean hasLogicalQueries;
    boolean hasSimpleQueries;
    int size;
